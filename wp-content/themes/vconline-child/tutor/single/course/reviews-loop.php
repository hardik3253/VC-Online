...
foreach ( $reviews as $review ) : ?>
	...
	$reviewer_name = ! empty( $review->display_name ) ? $review->display_name : ( ! empty( $review->comment_author ) ? $review->comment_author : __( 'Student', 'tutor' ) );
	?>
				...
				<div class="tutor-mb-12">
					<div class="tutor-avatar tutor-avatar-md tutor-review-avatar">
						<div class="tutor-ratio tutor-ratio-1x1">
							<img src="<?php echo esc_url( $avatar_image_src ); ?>" alt="<?php echo esc_attr( $reviewer_name ); ?>" class="tutor-avatar-img" />
						</div>
					</div>
				</div>
