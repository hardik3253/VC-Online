...
<?php else : ?>
	<div id="tutor-registration-wrap" class="tutor-card tutor-p-none tutor-py-9" style="max-width: 520px; margin: 0px auto;">
		...
		<form method="post" enctype="multipart/form-data" id="tutor-registration-form" class="tutor-p-8">
			...
			<div class="tutor-form-group">
				<label for="mobile_number" class="tutor-block tutor-mb-3"><?php esc_html_e( 'Mobile Number', 'tutor' ); ?></label>
				<div class="tutor-input-field tutor-mb-8">
					<input
						...
						id="mobile_number"
						name="mobile_number"
						value="<?php echo esc_attr( tutor_utils()->input_old( 'mobile_number' ) ); ?>"
						placeholder="<?php esc_attr_e( 'Enter Mobile Number', 'tutor' ); ?>"
						required
						autocomplete="tel">
				</div>
			</div>
