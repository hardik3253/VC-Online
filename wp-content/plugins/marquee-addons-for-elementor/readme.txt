...
= 3.9.86 - 2026-08-30 =
- Tweak: Allowed text formatting with bold, italic, and line breaks in Text Marquee.
...
= 3.9.79 - 2026-06-27 =
- New: Added a new review section template featuring a smooth testimonial scrolling effect.
...
= 3.9.74 - 2026-06-16 =
- New: Added a new hero section template with animated beam effect.

= 3.9.73 - 2026-06-11 =
- New: Added a new hero section template featuring an animated aurora background.

= 3.9.72 - 2026-06-07 =
- Tweak: Updated compatibility test for WordPress.

= 3.9.71 - 2026-06-03 =
- New: Added a new hero section template with an image accordion layout.

= 3.9.70 - 2026-06-02 =
- New: Added a new hero section template with image accordion.

= 3.9.69 - 2026-06-01 =
- New: Added a new image accordion hero section template.

= 3.9.68 - 2026-05-25 =
- New: Added a new hero section template with interactive image hotspots.

= 3.9.67 - 2026-05-20 =
- New: Added a new hero section template featuring interactive image hotspots.

= 3.9.66 - 2026-05-18 =
- New: Added a new image hotspots hero section template.

= 3.9.65 - 2026-05-17 =
- New: Added a new hero template with interactive image hotspots.

= 3.9.64 - 2026-05-16 =
- New: Added a new hero template with a Smooth Text rotation effect.

= 3.9.63 - 2026-05-14 =
- New: Added a new hero template featuring a 3D perspective geometric grid.

= 3.9.62 - 2026-05-13 =
- New: Added a new hero template featuring a 3D grid smooth image scrolling effect.
...
= 3.9.58 - 2026-05-09 =
- New: Added a new hero template with horizontal scrolling effect.

= 3.9.57 - 2026-05-07 =
- New: Added a new hero template with vertical scrolling effect.

= 3.9.56 - 2026-05-06 =
- New: Added a new hero template with text marquee.
...
= 3.9.48 - 2026-04-27 =
- New: Added a new hero template with smooth text rotation effect.

= 3.9.47 - 2026-04-26 =
- New: Added the `Instagram Marquee` widget (Pro).
...
= 3.9.37 - 2026-04-06 =
- New: Added responsive Display Size and Position controls to the Image Marquee widget.

= 3.9.36 - 2026-04-02 =
- New: Added Object Fit control to the Image Marquee widget.

= 3.9.35 - 2026-03-30 =
- Tweak: Removed unused control from the Video Marquee widget.

= 3.9.34 - 2026-03-28 =
- Tweak: Removed unused control from the Testimonial Marquee widget.

= 3.9.33 - 2026-03-26 =
- Fix: Prevented blank gaps in marquee tracks.
- Tweak: Improved track fill behavior for Text Marquee and Image Marquee.

= 3.9.32 - 2026-03-18 =
- Tweak: Removed unused control from the Image Marquee widget.

= 3.9.31 - 2026-03-15 =
- New: Added X and Y offset controls for text marquee icons.
- Tweak: Improved icon alignment control naming.
- Tweak: Enabled icon alignment control for all marquee orientations.

= 3.9.30 - 2026-03-12 =
- New: Added fallback notice when JavaScript is disabled.

= 3.9.29 - 2026-03-08 =
- Tweak: Added plugin URL.

= 3.9.28 - 2026-03-03 =
- New: Added button width control to set fixed button width.
...
= 3.9.5 - 2025-12-27 =
- Tweak: Updated control manager links
