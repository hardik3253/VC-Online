...
https://youtu.be/zZPF5nJD4mo?list=PLWHp1xKHCfxAj4AAs3kmzmDZKvjv6eycK
...
= 3.2.12 - 20/07/2026 =
Fixed: Unauthenticated Cookie-Scanner REST Routes.
Fixed: Plugin Check (PCP) issue fixed.
Fixed: Growth Alert (Inline): duplicate database queries for every product on WooCommerce shop/archive pages.
...
= 3.2.8 - 09/06/2026 =
Added: Elementor support for Exit Intent Popups
Added: Option to convert Announcement notifications into Exit Intent Popups
Added: NotificationX Form widget for Elementor
Added: New themes for Sales notifications.
Few minor bug fixes and improvements

= 3.2.7 - 20/05/2026 =
Added: Exit Intent Popup.
Added: WordPress 7.0 Compatibility.
Added: Countdown widget for Elementor.
Added: Option to customize recipient email address.
Few minor bug fixes and improvements.
...
= 3.2.4 - 16/03/2026 =
Added: Bit Integrations support.
Fixed: TypeError in WooCommerce notifications caused by call_user_func_array().
Few minor bug fixes and improvements.

= 3.2.3 - 05/03/2026 =
Fixed: Text domain related issue.
Fixed: Notification cross button closing issues in responsive mode.
Few minor bug fixes and stability improvements.

= 3.2.2 - 10/02/2026 =
Improved: Security enhancements (Reported by PatchStack).
Fixed: Missing state information when shipping address is empty.
Fixed: Notification Bar design wasn’t applying correctly when created with Gutenberg.
Few minor bug fixes and stability improvements.
...
Improved: Asset loading for notification bars created with Gutenberg.
Fixed: Minor bugs and overall performance enhancements.
