	...
	<div class="tutor-wp-dashboard-header tutor-px-24 tutor-pt-32 tutor-pb-20">
		...
		<div class="tutor-row tutor-gx-xl-5 tutor-fs-6">
			<div class="tutor-col-auto tutor-my-12">
				<span class="tutor-color-black tutor-fw-medium"><?php esc_html_e( 'Course', 'tutor-pro' ); ?>:</span> <span class="tutor-color-secondary"><?php echo esc_html( get_the_title( $submitted_assignment->comment_parent ) ); ?></span>
			</div>

			<div class="tutor-col-auto tutor-my-12">
				<span class="tutor-color-black tutor-fw-medium"><?php esc_html_e( 'Student', 'tutor-pro' ); ?>:</span> <span class="tutor-color-secondary"><?php echo esc_html( $submitted_assignment->comment_author ); ?></span>
			</div>
			...
			<div class="tutor-assignment-evaluation">
				...
				<form action="" method="post" class="tutor-form-submit-through-ajax" data-toast_success_message="<?php esc_attr_e( 'Assignment evaluated', 'tutor-pro' ); ?>">
					...
					<div class="tutor-form-group">
						...
						<textarea name="evaluate_assignment[instructor_note]" id="evaluate_assignment_instructor" class="tutor-form-control" rows="6"><?php echo esc_html( $instructor_note ); ?></textarea>
					</div>
					<div class="tutor-form-group">
