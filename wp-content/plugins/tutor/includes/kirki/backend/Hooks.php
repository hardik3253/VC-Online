...
use TutorLMSKirki\ElementGenerator\CourseMetaGenerator;
use TutorLMSKirki\ElementGenerator\ThumbnailGenerator;
...
class Hooks
{
    ...
    {
        add_filter('kirki_post_types', [$this, 'kirki_post_types'], 10, 1);
        add_filter('kirki_collection_TUTOR_LMS_COURSES', [$this, 'kirki_collection_TUTOR_LMS_COURSES'], 10, 2);
        add_filter('kirki_collection_TUTOR_LMS_CURRICULUM', [$this, 'kirki_collection_TUTOR_LMS_CURRICULUM'], 10, 2);
        add_filter('kirki_collection_TUTOR_LMS_CART', [$this, 'kirki_collection_TUTOR_LMS_CART'], 10, 2);
        add_filter('kirki_collection_TUTOR_LMS_MEMBERSHIP', [$this, 'kirki_collection_TUTOR_LMS_MEMBERSHIP'], 10, 2);
        add_filter('kirki_dynamic_content', [$this, 'kirki_dynamic_content'], 10, 2);
        add_filter('kirki_comment-TUTOR_LMS-tutor_q_and_a', [$this, 'modify_qna_comment_data']);
        add_filter('kirki_comment-TUTOR_LMS-tutor_course_rating', [$this, 'modify_rating_comment_data']);
        add_filter('kirki_comment_added-TUTOR_LMS-tutor_q_and_a', [$this, 'qna_comment_added']);
        add_filter('kirki_comment_added-TUTOR_LMS-tutor_course_rating', [$this, 'rating_comment_added']);
        add_filter('kirki_visibility_condition_fields', [VisibilityCondition::class, 'visibility_condition_fields'], 10, 2);
        add_filter('kirki_visibility_condition_check_' . TDE_APP_PREFIX, [VisibilityCondition::class, 'element_visibility_condition_check'], 10, 3);

        add_filter('kirki_dynamic_content_fields', [$this, 'modify_kirki_dynamic_content_fields'], 10, 2);
        add_filter('kirki_external_collection_options', [$this, 'modify_external_collection_options'], 10, 2);
        add_filter('kirki_external_collection_item_type', [$this, 'get_tutor_item_types'], 10, 2);
        add_filter('kirki_element_generator_radio-button', [$this, 'kirki_element_generator_radio_buttons'], 10, 2);

        add_filter('kirki_import_should_create_page', [$this, 'kirki_import_should_create_page'], 10, 2);
        add_action('kirki_import_page_created', [$this, 'kirki_import_page_created'], 10, 2);

        // $show = apply_filters('kirki_show_custom_section_' . $type, true);
        add_filter('kirki_show_custom_section_header', [$this, 'show_kirki_header'], 10, 1);
        add_filter('kirki_show_custom_section_footer', [$this, 'show_kirki_footer'], 10, 1);
    }
    ...
    public function kirki_import_should_create_page($flag, $old_page_data)
    {
    ...
    public function kirki_import_page_created($new_page_id, $old_page_data)
    {
    ...
    public function modify_kirki_dynamic_content_fields($fields, $collection_data)
    {
  ...
  public function modify_external_collection_options($options, $args)
    ...
    public function kirki_post_types($post_types)
    {
        $post_types[] = [
            'title' => 'Course Topics',
            'value' => 'topics',
    ...
    public function kirki_collection_TUTOR_LMS_COURSES($value, $args)
    {
    ...
    public function kirki_collection_TUTOR_LMS_CURRICULUM($value, $args)
    {
    ...
    public function kirki_collection_TUTOR_LMS_MEMBERSHIP($value, $args)
    {
    ...
    public function kirki_element_generator_radio_buttons($value, $options)
    {
